...
import com.github.malayP.decorations.register.AllTileEntity.enhancedBedrockBreakerType
...
class EnhancedBedrockBreaker : HorizonBlockWithTileEntity(Properties.create(Material.IRON)) {
    override fun createTileEntity(state: BlockState?, world: IBlockReader?): TileEntity =
        EnhancedBedrockBreakerTileEntity()
}

class EnhancedBedrockBreakerTileEntity : TileEntity(enhancedBedrockBreakerType.get()) {}
class EnhancedBedrockBreakerTileEntityRender(dispatcher: TileEntityRendererDispatcher) :
    TileEntityRenderer<EnhancedBedrockBreakerTileEntity>(dispatcher) {
    companion object {
        val model = EnhancedBedrockBreakerModel()
        val texture: ResourceLocation= modResourcesLocation("textures/tile_entity/production/enhanced_bedrock_breaker/enhanced_bedrock_breaker.png")
    }

    override fun render(
        tileEntityIn: EnhancedBedrockBreakerTileEntity,
        partialTicks: Float,
...
class EnhancedBedrockBreakerModel : Model(RenderType::getEntitySolid) {
    ...
    init {
        ...
        bone.setTextureOffset(49, 10).addBox(-2.0f, -6.5f, -0.75f, 4.0f, 1.0f, 2.0f, 0.0f, false)
        bone.setTextureOffset(49, 10).addBox(-2.0f, 5.5f, -0.75f, 4.0f, 1.0f, 2.0f, 0.0f, false)
        ...
        cube_r16.setTextureOffset(49, 10).addBox(-2.0f, 5.5f, -1.0f, 4.0f, 1.0f, 2.0f, 0.0f, false)
        cube_r16.setTextureOffset(49, 10).addBox(-2.0f, -6.5f, -1.0f, 4.0f, 1.0f, 2.0f, 0.0f, false)
