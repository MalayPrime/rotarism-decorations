...
import com.github.malayP.decorations.register.AllTileEntity.shaftPowerBusControllerType
...
class ShaftPowerBusController : HorizonBlockWithTileEntity(Properties.create(Material.IRON)) {
    override fun createTileEntity(state: BlockState?, world: IBlockReader?): TileEntity =
        ShaftPowerBusControllerTileEntity()
}

class ShaftPowerBusControllerTileEntity : TileEntity(shaftPowerBusControllerType.get()) {

}

class ShaftPowerBusControllerTileEntityRender(dispatcher: TileEntityRendererDispatcher) :
    TileEntityRenderer<ShaftPowerBusControllerTileEntity>(dispatcher) {
    companion object {
        val model = ShaftPowerBusControllerModel()
        val texture =
            modResourcesLocation("textures/tile_entity/transmission/shaft_power_bus_controller/shaft_power_bus_controller.png")
    }

    override fun render(
        tileEntityIn: ShaftPowerBusControllerTileEntity,
        partialTicks: Float,
...
class ShaftPowerBusControllerModel : Model(RenderType::getEntitySolid) {
    ...
    init {
        ...
        fixed.addChild(pos)
        pos.setTextureOffset(0, 0).addBox(-5.0f, -13.0f, -5.0f, 10.0f, 10.0f, 12.0f, 0.0f, false)
        pos.setTextureOffset(50, 106).addBox(2.0f, -16.0f, 2.0f, 6.0f, 16.0f, 6.0f, 0.0f, false)
        pos.setTextureOffset(0, 94).addBox(2.0f, -16.0f, -8.0f, 6.0f, 16.0f, 6.0f, 0.0f, false)
        pos.setTextureOffset(95, 97).addBox(-8.0f, -16.0f, 2.0f, 6.0f, 16.0f, 6.0f, 0.0f, false)
        pos.setTextureOffset(25, 96).addBox(-8.0f, -16.0f, -8.0f, 6.0f, 16.0f, 6.0f, 0.0f, false)
        pos.setTextureOffset(100, 56).addBox(-2.0f, -16.0f, 2.0f, 4.0f, 6.0f, 6.0f, 0.0f, false)
        pos.setTextureOffset(100, 17).addBox(-2.0f, -6.0f, 2.0f, 4.0f, 6.0f, 6.0f, 0.0f, false)
        pos.setTextureOffset(100, 38).addBox(-2.0f, -16.0f, -8.0f, 4.0f, 6.0f, 6.0f, 0.0f, false)
        pos.setTextureOffset(70, 20).addBox(-2.0f, -6.0f, -8.0f, 4.0f, 6.0f, 6.0f, 0.0f, false)
        pos.setTextureOffset(115, 30).addBox(2.0f, -6.0f, -2.0f, 6.0f, 6.0f, 4.0f, 0.0f, false)
        pos.setTextureOffset(51, 93).addBox(-8.0f, -6.0f, -2.0f, 6.0f, 6.0f, 4.0f, 0.0f, false)
        pos.setTextureOffset(110, 0).addBox(2.0f, -16.0f, -2.0f, 6.0f, 6.0f, 4.0f, 0.0f, false)
        pos.setTextureOffset(100, 74).addBox(-8.0f, -16.0f, -2.0f, 6.0f, 6.0f, 4.0f, 0.0f, false)
        ...
        input.addChild(bone)
        bone.setTextureOffset(90, 0).addBox(-1.0f, 7.0f, -6.5f, 2.0f, 1.0f, 15.0f, 0.0f, false)
        ...
        bone3.setTextureOffset(60, 89).addBox(4.5858f, 1.4142f, -6.5f, 2.0f, 1.0f, 15.0f, 0.0f, false)
        ...
        bone6.setTextureOffset(0, 59).addBox(-4.9497f, -2.5355f, -6.5f, 2.0f, 2.0f, 15.0f, 0.0f, false)
        ...
        bone8.setTextureOffset(40, 58).addBox(-4.9497f, 5.364f, -6.5f, 2.0f, 2.0f, 15.0f, 0.0f, false)
        ...
        bone17.setTextureOffset(40, 76).addBox(-1.0f, 7.0f, -6.5f, 2.0f, 1.0f, 15.0f, 0.0f, false)
        ...
        bone18.setTextureOffset(40, 40).addBox(2.9497f, 5.364f, -6.5f, 2.0f, 2.0f, 15.0f, 0.0f, false)
        ...
        bone19.setTextureOffset(60, 72).addBox(4.5858f, 1.4142f, -6.5f, 2.0f, 1.0f, 15.0f, 0.0f, false)
        ...
        bone20.setTextureOffset(30, 8).addBox(2.9497f, -2.5355f, -6.5f, 2.0f, 2.0f, 15.0f, 0.0f, false)
        ...
        bone21.setTextureOffset(70, 3).addBox(-1.0f, -4.1716f, -6.5f, 2.0f, 1.0f, 15.0f, 0.0f, false)
        ...
        bone22.setTextureOffset(20, 26).addBox(-4.9497f, -2.5355f, -6.5f, 2.0f, 2.0f, 15.0f, 0.0f, false)
        ...
        bone23.setTextureOffset(20, 62).addBox(-6.5858f, 1.4142f, -6.5f, 2.0f, 1.0f, 15.0f, 0.0f, false)
        ...
        bone24.setTextureOffset(0, 23).addBox(-4.9497f, 5.364f, -6.5f, 2.0f, 2.0f, 15.0f, 0.0f, false)
        ...
        bone9.setTextureOffset(80, 21).addBox(-1.0f, 7.0f, -6.5f, 2.0f, 1.0f, 15.0f, 0.0f, false)
        ...
        bone10.setTextureOffset(50, 18).addBox(2.9497f, 5.364f, -6.5f, 2.0f, 2.0f, 15.0f, 0.0f, false)
        ...
        bone11.setTextureOffset(80, 80).addBox(4.5858f, 1.4142f, -6.5f, 2.0f, 1.0f, 15.0f, 0.0f, false)
        ...
        bone12.setTextureOffset(50, 0).addBox(2.9497f, -2.5355f, -6.5f, 2.0f, 2.0f, 15.0f, 0.0f, false)
        ...
        bone13.setTextureOffset(20, 79).addBox(-1.0f, -4.1716f, -6.5f, 2.0f, 1.0f, 15.0f, 0.0f, false)
        ...
        bone14.setTextureOffset(20, 44).addBox(-4.9497f, -2.5355f, -6.5f, 2.0f, 2.0f, 15.0f, 0.0f, false)
        ...
        bone15.setTextureOffset(0, 77).addBox(-6.5858f, 1.4142f, -6.5f, 2.0f, 1.0f, 15.0f, 0.0f, false)
        ...
        bone16.setTextureOffset(0, 41).addBox(-4.9497f, 5.364f, -6.5f, 2.0f, 2.0f, 15.0f, 0.0f, false)
